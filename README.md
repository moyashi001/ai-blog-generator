...
7. Claude Pro貼り付け用のブログ記事生成プロンプトを自動生成（WordPress SWELLにそのまま貼り付けられるHTML出力、ブログ「もや暮らし」の文体を踏襲する指示、アフィリエイトリンクを商品画像＋ボタンのカード形式で出力する指示、タイトル案3つ・メタディスクリプション・SEOキーワードを本文と合わせて生成させるSEO指示）
8. 生成されたプロンプトのコピーUI
